...
if (!function_exists("PrintPropsForm"))
{
	function PrintPropsForm($arSource = array(), $locationTemplate = ".default")
	{
		if (!empty($arSource))
		{
			$ELEMENTS_PER_COLUMN = floor(count($arSource) / 2);
			?>
				<div class="user-info-block">
					...
					{
						//if($index++ == $ELEMENTS_PER_COLUMN){
						if($arProperties["SORT"] == 1000){
							echo '</div><div class="sub-block">';
						}
						...
						{
							?>
							<label <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>class="required"<?endif;?>><?=$arProperties["NAME"]?></label>
							<?
							if (strlen(trim($arProperties["DESCRIPTION"])) > 0):
								?><div class="bx_description">
								<?=$arProperties["DESCRIPTION"]?>
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
							...
							?><label <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>class="required"<?endif;?>><?=$arProperties["NAME"]?></label>
							<?if (strlen(trim($arProperties["DESCRIPTION"])) > 0):?><div class="bx_description">
								<?=$arProperties["DESCRIPTION"]?>
							</div><?endif;?>
