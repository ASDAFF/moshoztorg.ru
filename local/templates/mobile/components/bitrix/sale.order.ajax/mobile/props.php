...
?>
	...
	if (is_array($arResult["ORDER_PROP"]["USER_PROFILES"]) && !empty($arResult["ORDER_PROP"]["USER_PROFILES"])):
		...
		?><div class="formline">
			<p class="formheading"><?=GetMessage("SOA_TEMPL_PROP_CHOOSE")?></p>
		...
		?><div class="formline">
			<p class="formheading"><?=GetMessage("SOA_TEMPL_EXISTING_PROFILE")?></p>
...
<div class="formline">
	<p class="formheading"><?=GetMessage("SOA_TEMPL_BUYER_INFO")?></p>
