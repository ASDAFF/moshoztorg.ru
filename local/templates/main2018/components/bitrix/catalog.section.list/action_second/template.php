...
if (0 < $arResult["SECTIONS_COUNT"]) {
    ...
    <!--===================================================== section discover -->
    <section class="section-discover" id="discover" style='background: url("<?= $arSection['PICTURE']['SRC'] ?>") no-repeat 50% 0 transparent;'>
        <div class="container">
            ...
            <? if ($arSection['UF_PERCENT']) { ?>
                <div class="discount-big">
                    <div class="pseudo-table">
                        <div class="pseudo-table-cell">
                            <div class="percent"><?= $arSection['UF_PERCENT'] ?>
                                 <? if ($arSection['UF_IS_PERCENT']) { ?>
                                    <sup>%</sup>
                                <? } ?>
                            </div>
                        </div>
