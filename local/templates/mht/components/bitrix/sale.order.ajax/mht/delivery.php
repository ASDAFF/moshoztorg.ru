...
<script>
function IPOLIML_DeliveryChangeEvent(id) { //название принципиально
     $('#'+id).prop('checked', 'Y');
     submitForm();
}
</script>
<input type="hidden" name="BUYER_STORE" id="BUYER_STORE" value="<?=$arResult["BUYER_STORE"]?>" />
<div class="bx_section delivery-systems pay_system">
	<?
						...
						<div class="bx_element">
							...
							<label for="ID_DELIVERY_<?=$delivery_id?>_<?=$profile_id?>">
								...
								<div class="bx_description">
									...
									<div class="name"><strong onclick="BX('ID_DELIVERY_<?=$delivery_id?>_<?=$profile_id?>').checked=true;<?=$extraParams?>submitForm();">
