...
<?foreach($arResult["ITEMS"] as $key=>$arItem):
	...
	?>
		<div id="<? echo $strRowID; ?>" class="bx_slider_block<?echo ($boolFirst ? ' active' : ''); ?>" style="width:<? echo $strItemWidth; ?>%;">
			...
			<div class="bx_slider_content_container" itemscope=itemscope itemtype="http://schema.org/Product">
				<h1 class="bx_slider_title"><span itemprop="name"><a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?=$arItem["NAME"]?></a></span></h1>
