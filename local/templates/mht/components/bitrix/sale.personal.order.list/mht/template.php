...
?>
   <div class="my_orders_page">
      <div class="my_orders">
        <h1>мои заказы</h1> 
		<?/* <p style="color:#f00;"><br />Уважаемые покупатели! В связи с новогодними праздниками сроки доставки могут измениться.<br />Просьба уточнять сроки доставки у менеджеров магазина по телефону 8&nbsp;(800)&nbsp;550-47-47</p> */?>
					                ...
					                <div class="description_block">
					                	<div class="float-right">
											...
											if (
												...
												?>
													<div class="payment_block">
														<?include("/var/data/mht/www/bitrix/modules/sale/payment/roboxchange/payment.php");?>
													</div>
												<?
											}
											...
											<div class="status_block">
												<div class="status">
													<div class="date"><?=ConvertDateTime($order["ORDER"]["DATE_STATUS"], "DD.MM.YYYY", "ru");?></div>
													<div class="name"><?=$arStatus['NAME']//($order["ORDER"]["PAYED"] == "Y" ? "Принят, оплачен" : "Принят, ожидается оплата")?></div>
												</div>
												<div class="buttons">
													<a href="<?=$order["ORDER"]["URL_TO_CANCEL"]?>">отменить заказ</a><a href="<?=$order["ORDER"]["URL_TO_COPY"]?>">повторить заказ</a>
												</div>
											</div>
										</div>
										<div class="description">
					                        ...
					                        <table>
					                            <tbody><tr><td><span>сумма к оплате:</span></td><td><?=$order["ORDER"]["FORMATED_PRICE"]?></td></tr>
					                                <tr><td><span>оплачен:</span></td><td>нет</td></tr>
