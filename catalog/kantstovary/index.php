...
$APPLICATION->SetTitle("Канцтовары");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/kantstovary/",
		"IBLOCK_ID" => "536",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"15" => "MOSHCHNOST",
			"16" => "PROIZVODITEL_I_ADRES_PROIZVODSTVA",
			"17" => "IMPORTER",
			"18" => "PRIEM_PRETENZIY",
			...
			"64" => "RAZMER",
			"65" => "MARKET",
			"66" => "ANTIPRIGARNOE_POKRYTIE",
			"67" => "KRYSHKA_V_KOMPLEKTE",
			"68" => "SEMNYE_RUCHKI",
			"69" => "VODOOTTALKIVAYUSHCHIY_EFFEKT",
			"70" => "S_VOSKOM",
			"71" => "AROMATIZIROVANNAYA",
			"72" => "DLYA_TORTA",
			"73" => "CHAYNAYA",
			"74" => "V_STAKANE",
			"75" => "S_PODOGREVOM",
			"76" => "MASSAZHNYE",
			"77" => "LETNIE",
			"78" => "NATURALNAYA_SHCHETINA",
			"79" => "AROMAT",
			"80" => "ZONT_TROST",
			"81" => "MINI_ZONT",
			"82" => "CHEKHOL",
			"83" => "SISTEMA_ANTIVETER",
			"84" => "CHISLO_SPITS",
			"85" => "PROZRACHNYY",
			"86" => "KUPOL",
			"87" => "OTZHIM",
			...
			"96" => "NAGRUZKA",
			"97" => "TIP_KOLES",
			"98" => "KOLICHESTVO_KOLES",
			"99" => "DIAMETR_KOLES",
			"100" => "TORMOZ",
			"101" => "DLINA_DEKI",
			"102" => "DLYA_KURYASHCHIKH",
			"103" => "ANKER_BOLT",
			"104" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"105" => "FENY_PROMYSHLENNYE",
			"106" => "VOZDUKHODUVKI",
			"107" => "ZHESTKOST",
			"108" => "ODNORAZOVYY",
			"109" => "SAYTBEZSKIDKI",
			...
			"114" => "SOGLASOVANO",
			"115" => "OTPRAVLENY_ORIGINALY",
			"116" => "VOZVRAT_DOKUMENTOV",
