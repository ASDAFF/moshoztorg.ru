...
$APPLICATION->SetTitle("Соки, Воды");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/soki_vody/",
		"IBLOCK_ID" => "523",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"29" => "SAYT_NOVINKA",
			"30" => "SAYT_NA_GLAVNUYU",
			"31" => "SAYT_AKTSIONNYY_TOVAR",
			"32" => "OBORUDOVANIE",
			"33" => "NE_VYGRUZHAT_NA_SAYT",
			"34" => "FORMA",
			"35" => "TSVET",
			"36" => "NABOR",
			"37" => "DLYA_DETEY",
			...
			"41" => "USLOVIYA_KHRANENIYA",
			"42" => "DATA_PROIZVODSTVA",
			"43" => "PRIMENENIE",
			"44" => "SERTIFIKATSIYA",
			"45" => "STANDART",
			"46" => "EDIZMRAZMERA",
			...
			"59" => "MINI_ZONT",
			"60" => "CHEKHOL",
			"61" => "SISTEMA_ANTIVETER",
			"62" => "CHISLO_SPITS",
			"63" => "PROZRACHNYY",
			"64" => "KUPOL",
			"65" => "SOSTOYANIE_SBORKI",
			"66" => "OTZHIM",
			"67" => "TELESKOPICHESKAYA_RUCHKA",
			"68" => "MATERIAL_MOPA",
			"69" => "KONSTRUKTSIYA_NASADKI",
			"70" => "TIP_NASADKI",
			"71" => "POKRYTIE",
			"72" => "TERMOINDIKATOR",
			"73" => "ANTIPRIGARNOE_POKRYTIE",
			"74" => "GRUZOPODEMNOST",
			"75" => "VYSOTA_RULYA",
			"76" => "NAGRUZKA",
			"77" => "TIP_KOLES",
			...
			"81" => "DLINA_DEKI",
			"82" => "DLYA_KURYASHCHIKH",
			"83" => "PROIZVODITEL_I_ADRES_PROIZVODSTVA",
			"84" => "GARANTIYNYY_SROK",
			"85" => "SROK_GODNOSTI",
			"86" => "TIP_1",
			"87" => "MATERIAL_1",
			...
			"100" => "ADMITAD_TARIFF",
			"101" => "OTPRAVLENO",
			"102" => "TOLKO_V_INTERNET_MAGAZINE",
			"103" => "NE_PRODAVAT_V_MINUS",
			"104" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"105" => "FENY_PROMYSHLENNYE",
			"106" => "VOZDUKHODUVKI",
			"107" => "SHVABRY_S_OTZHIMOM",
			"108" => "SHVABRY_NASADKI",
			"109" => "OKNOMOYKI",
