...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"37" => "SAYT_NOVINKA",
			"38" => "SAYT_NA_GLAVNUYU",
			"39" => "SAYT_AKTSIONNYY_TOVAR",
			"40" => "OPISANIE",
			"41" => "SOBRAN",
			"42" => "SAYT_BLACK_FRIDAY_TOVAR",
			"43" => "OLD_PRICE_1",
			"44" => "MOSHCHNOST",
			"45" => "NAIMENOVANIE",
			"46" => "OBORUDOVANIE",
			"47" => "NAIMENOVANIE_DLYA_SAYTA",
			"48" => "FORMA",
			"49" => "TSVET",
			"50" => "NABOR",
			"51" => "DLYA_DETEY",
			...
			"74" => "O2",
			"75" => "kolvo_tabletok",
			"76" => "dlya_detskoy_posudy",
			"77" => "dlya_fruktov_ovoschey",
			"78" => "antibacterial",
			"79" => "OTPRAVLENO",
			"80" => "TOLKO_V_INTERNET_MAGAZINE",
			"81" => "type_tkani",
			"82" => "type_sredstva",
			"83" => "NE_PRODAVAT_V_MINUS",
			"84" => "NOPHOSPHOR",
			"85" => "Tip_poverhnosty",
			"86" => "NE_VYGRUZHAT_NA_SAYT",
			"87" => "OVOSHCHI",
			"88" => "TRYAPKI",
			"89" => "SALFETKI",
			"90" => "MOSHCHNOST_1",
			"91" => "ANKER_BOLT",
			"92" => "SHVABRY_S_OTZHIMOM",
			"93" => "SHVABRY_NASADKI",
			"94" => "OKNOMOYKI",
			"95" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"96" => "FENY_PROMYSHLENNYE",
			"97" => "VOZDUKHODUVKI",
			"98" => "SOGLASOVANO",
			"99" => "OTPRAVLENY_ORIGINALY",
			"100" => "VOZVRAT_DOKUMENTOV",
