...
$APPLICATION->SetTitle("Бытовая техника");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/bytovaya_tekhnika/",
		"IBLOCK_ID" => "461",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"33" => "SAYT_NOVINKA",
			"34" => "SAYT_NA_GLAVNUYU",
			"35" => "SAYT_AKTSIONNYY_TOVAR",
			"36" => "SAMOVYVOZ",
			"37" => "OPISANIE",
			"38" => "SOBRAN",
			"39" => "SAYT_BLACK_FRIDAY_TOVAR",
			"40" => "OLD_PRICE_1",
			"41" => "NE_VYGRUZHAT_NA_SAYT",
			"42" => "NAIMENOVANIE_DLYA_SAYTA",
			"43" => "NABOR",
			"44" => "BUMAGA",
			"45" => "KOLICHESTVO_CHEKOV",
			"46" => "SREDNIY_CHEK",
			"47" => "KOLICHESTVO_POSETITELEY",
			"48" => "VOZVRAT_DOKUMENTOV",
			"49" => "RAZMER",
			"50" => "KOLICHESTVO",
			"51" => "SOSTAV",
			"52" => "MODEL",
			...
			"73" => "TIP_1",
			"74" => "MATERIAL_1",
			"75" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"76" => "FENY_PROMYSHLENNYE",
			"77" => "VOZDUKHODUVKI",
			"78" => "ZHESTKOST",
			"79" => "ODNORAZOVYY",
			"80" => "NoDiscount",
