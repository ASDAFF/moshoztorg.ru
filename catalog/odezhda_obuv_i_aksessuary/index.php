...
$APPLICATION->SetTitle("Одежда, обувь и аксессуары");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/odezhda_obuv_i_aksessuary/",
		"IBLOCK_ID" => "538",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"50" => "DLYA_DETEY",
			"51" => "POKRYTIE",
			"52" => "VODOOTTALKIVAYUSHCHIY_EFFEKT",
			"53" => "S_VOSKOM",
			"54" => "BESTSVETNYY",
			"55" => "MASSAZHNYE",
			"56" => "LETNIE",
			"57" => "NATURALNAYA_SHCHETINA",
			"58" => "ZONT_TROST",
			"59" => "MINI_ZONT",
			"60" => "CHEKHOL",
			...
			"64" => "POL",
			"65" => "KUPOL",
			"66" => "SOSTOYANIE_SBORKI",
			"67" => "SHNURKI",
			"68" => "KOMPLEKT",
			"69" => "SAYT_BLACK_FRIDAY_TOVAR",
			"70" => "KOLICHESTVO",
			"71" => "SOSTAV",
			"72" => "MODEL",
			"73" => "PROPITKI",
			...
			"101" => "SOGLASOVANO",
			"102" => "OTPRAVLENY_ORIGINALY",
			"103" => "VOZVRAT_DOKUMENTOV",
			"104" => "NE_VYGRUZHAT_NA_SAYT",
			"105" => "OLD_PRICE_3",
