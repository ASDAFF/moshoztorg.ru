...
$APPLICATION->SetTitle("Косметика и гигиена");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/kosmetika_i_gigiena/",
		"IBLOCK_ID" => "471",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"10" => "IMPORTER",
			"11" => "PRIEM_PRETENZIY",
			"12" => "USLOVIYA_KHRANENIYA",
			"13" => "DATA_PROIZVODSTVA",
			"14" => "GARANTIYNYY_SROK",
			"15" => "PRIMENENIE",
			"16" => "SERTIFIKATSIYA",
			"17" => "SROK_GODNOSTI",
			...
			"42" => "OPISANIE",
			"43" => "SOBRAN",
			"44" => "KOLICHESTVO_POLOZHENIY_MAYATNIKOGO_KHODA",
			...
			"68" => "ANKER_BOLT",
			"69" => "NAZNACHENIE",
			"70" => "SHVABRY_S_OTZHIMOM",
			"71" => "SHVABRY_NASADKI",
			"72" => "OKNOMOYKI",
			"73" => "TIP",
			"74" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"75" => "FENY_PROMYSHLENNYE",
			"76" => "VOZDUKHODUVKI",
			"77" => "STRANA_PROIZVODITEL_1",
			"78" => "SAYTBEZSKIDKI",
			"79" => "AROMAT",
			"80" => "ADMITAD_TARIFF",
			"81" => "OTPRAVLENO",
			"82" => "Time",
			"83" => "Skin_type",
			"84" => "TOLKO_V_INTERNET_MAGAZINE",
			"85" => "Tip_volos",
			"86" => "SILA_FIKSACII",
			"87" => "Type_stanka",
			"88" => "Type_zakolki",
			"89" => "NE_PRODAVAT_V_MINUS",
			"90" => "VREDNYE",
			"91" => "Tsvet_volos",
			"92" => "Oblast_nanesenia",
			"93" => "Vid_sredstva",
			"94" => "SOGLASOVANO",
			"95" => "OTPRAVLENY_ORIGINALY",
			"96" => "VOZVRAT_DOKUMENTOV",
			"97" => "OLD_PRICE_3",
