...
$APPLICATION->SetTitle("Товары для сада");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/tovary_dlya_sada/",
		"IBLOCK_ID" => "497",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"43" => "OPISANIE",
			"44" => "SOBRAN",
			"45" => "KOLICHESTVO_POLOZHENIY_MAYATNIKOGO_KHODA",
			"46" => "REGULIROVKA_CHASTOTY_KHODA",
			"47" => "SAYT_BLACK_FRIDAY_TOVAR",
			"48" => "OLD_PRICE_1",
			"49" => "MOSHCHNOST",
			"50" => "NAIMENOVANIE",
			"51" => "OBORUDOVANIE",
			"52" => "NE_VYGRUZHAT_NA_SAYT",
			"53" => "NAIMENOVANIE_DLYA_SAYTA",
			"54" => "FORMA",
			"55" => "TSVET",
			"56" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"57" => "FENY_PROMYSHLENNYE",
			"58" => "VOZDUKHODUVKI",
			"59" => "NABOR",
			"60" => "DLYA_DETEY",
			"61" => "POKRYTIE",
			...
			"83" => "EDIZMRAZMERA",
			"84" => "TIPSEMYA",
			"85" => "TOLKO_V_INTERNET_MAGAZINE",
			"86" => "NE_PRODAVAT_V_MINUS",
