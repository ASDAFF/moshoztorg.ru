...
$APPLICATION->SetTitle("Авто-товары");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/avto_tovary/",
		"IBLOCK_ID" => "457",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"41" => "SAYT_NOVINKA",
			"42" => "SAYT_NA_GLAVNUYU",
			"43" => "SAYT_AKTSIONNYY_TOVAR",
			"44" => "SAMOVYVOZ",
			"45" => "OPISANIE",
			"46" => "SOBRAN",
			"47" => "KEYS",
			"48" => "SAYT_BLACK_FRIDAY_TOVAR",
			"49" => "OLD_PRICE_1",
			"50" => "MOSHCHNOST",
			"51" => "NAIMENOVANIE",
			"52" => "TIP_VELOSIPEDA",
			...
			"55" => "KARETKA",
			"56" => "OBORUDOVANIE",
			"57" => "NE_VYGRUZHAT_NA_SAYT",
			"58" => "OVOSHCHI",
			"59" => "NAIMENOVANIE_DLYA_SAYTA",
			"60" => "FORMA",
			"61" => "TSVET",
			"62" => "NABOR",
			"63" => "DLYA_DETEY",
			...
			"65" => "SALFETKI",
			"66" => "ANKER_BOLT",
			"67" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"68" => "FENY_PROMYSHLENNYE",
			"69" => "VOZDUKHODUVKI",
			"70" => "POKRYTIE",
			"71" => "ANTIPRIGARNOE_POKRYTIE",
			"72" => "KRYSHKA_V_KOMPLEKTE",
			"73" => "SEMNYE_RUCHKI",
			"74" => "VODOOTTALKIVAYUSHCHIY_EFFEKT",
			"75" => "S_VOSKOM",
			"76" => "BESTSVETNYY",
			"77" => "PRAZDNIK",
			"78" => "AROMATIZIROVANNAYA",
			"79" => "DLYA_TORTA",
			"80" => "CHAYNAYA",
			"81" => "V_STAKANE",
			"82" => "RAZMER",
			...
			"84" => "MASSAZHNYE",
			"85" => "LETNIE",
			"86" => "NATURALNAYA_SHCHETINA",
			"87" => "POL",
			"88" => "OTZHIM",
			"89" => "TELESKOPICHESKAYA_RUCHKA",
			"90" => "MATERIAL_MOPA",
			"91" => "KONSTRUKTSIYA_NASADKI",
			"92" => "TIP_NASADKI",
			"93" => "KOMPLEKT",
			"94" => "KOLICHESTVO",
			"95" => "SOSTAV",
			...
			"103" => "NAGRUZKA",
			"104" => "TIP_KOLES",
			"105" => "KOLICHESTVO_KOLES",
			"106" => "DIAMETR_KOLES",
			"107" => "TORMOZ",
			"108" => "DLINA_DEKI",
			"109" => "DLYA_KURYASHCHIKH",
			"110" => "MARKET",
			"111" => "ZHESTKOST",
			"112" => "ODNORAZOVYY",
			"113" => "SAYTBEZSKIDKI",
			...
			"115" => "ADMITAD_TARIFF",
			"116" => "OTPRAVLENO",
			"117" => "TOLKO_V_INTERNET_MAGAZINE",
			"118" => "NE_PRODAVAT_V_MINUS",
			"119" => "SOGLASOVANO",
			"120" => "OTPRAVLENY_ORIGINALY",
			"121" => "VOZVRAT_DOKUMENTOV",
			"122" => "OLD_PRICE_3",
