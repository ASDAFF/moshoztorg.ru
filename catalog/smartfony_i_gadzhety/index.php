...
$APPLICATION->SetTitle("Смартфоны и гаджеты");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/smartfony_i_gadzhety/",
		"IBLOCK_ID" => "561",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"13" => "OBORUDOVANIE",
			"14" => "OVOSHCHI",
			"15" => "TOLKO_V_INTERNET_MAGAZINE",
			"16" => "NE_PRODAVAT_V_MINUS",
			"17" => "NAIMENOVANIE_DLYA_SAYTA",
			"18" => "FORMA",
			"19" => "TSVET",
			"20" => "NABOR",
			"21" => "DLYA_DETEY",
			...
			"28" => "SALFETKI",
			"29" => "MOSHCHNOST",
			"30" => "PROIZVODITEL_I_ADRES_PROIZVODSTVA",
			"31" => "IMPORTER",
			"32" => "PRIEM_PRETENZIY",
			"33" => "STRANA_PROIZVODITEL",
			"34" => "USLOVIYA_KHRANENIYA",
			"35" => "DATA_PROIZVODSTVA",
			"36" => "GARANTIYNYY_SROK",
			"37" => "PRIMENENIE",
			"38" => "SERTIFIKATSIYA",
			"39" => "SROK_GODNOSTI",
