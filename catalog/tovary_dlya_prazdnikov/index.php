...
$APPLICATION->SetTitle("Товары для праздников");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/tovary_dlya_prazdnikov/",
		"IBLOCK_ID" => "540",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"17" => "SALFETKI",
			"18" => "MOSHCHNOST",
			"19" => "PROIZVODITEL_I_ADRES_PROIZVODSTVA",
			"20" => "IMPORTER",
			"21" => "PRIEM_PRETENZIY",
			"22" => "STRANA_PROIZVODITEL",
			"23" => "USLOVIYA_KHRANENIYA",
			"24" => "DATA_PROIZVODSTVA",
			"25" => "GARANTIYNYY_SROK",
			"26" => "PRIMENENIE",
			"27" => "SERTIFIKATSIYA",
			"28" => "SROK_GODNOSTI",
			...
			"30" => "TIPOBSHCHIY",
			"31" => "MATERIALOBSHCHIY",
			"32" => "NAZNACHENIEOBSHCHIY",
			"33" => "MOSHCHNOSTOBSHCHAYA",
			"34" => "DIAMETROBSHCHIY",
			"35" => "DLINNAOBSHCHIY",
			"36" => "SHIRINAOBSHCHIY",
			"37" => "VYSOTAOBSHCHIY",
			"38" => "RAZMEROBSHCHIY",
			"39" => "EDIZMRAZMERAOBSHCHIY",
			"40" => "SHTRIKHKODA",
			"41" => "NOVINKA",
			"42" => "OBEMOBSHCHIY",
			"43" => "VESOBSHCHIY",
			...
			"73" => "NAGRUZKA",
			"74" => "TIP_KOLES",
			"75" => "KOLICHESTVO_KOLES",
			"76" => "DIAMETR_KOLES",
			"77" => "TORMOZ",
			"78" => "DLINA_DEKI",
			"79" => "DLYA_KURYASHCHIKH",
			"80" => "ANKER_BOLT",
			"81" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"82" => "FENY_PROMYSHLENNYE",
			"83" => "VOZDUKHODUVKI",
			"84" => "ZHESTKOST",
			"85" => "ODNORAZOVYY",
			"86" => "AROMAT",
			...
			"89" => "OTPRAVLENO",
			"90" => "vid_tovara",
			"91" => "TOLKO_V_INTERNET_MAGAZINE",
			"92" => "NE_PRODAVAT_V_MINUS",
			"93" => "SHVABRY_S_OTZHIMOM",
			"94" => "SHVABRY_NASADKI",
			"95" => "OKNOMOYKI",
