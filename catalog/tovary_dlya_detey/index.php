...
$APPLICATION->SetTitle("Товары для детей");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/tovary_dlya_detey/",
		"IBLOCK_ID" => "544",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"60" => "MARKET",
			"61" => "OVOSHCHI",
			"62" => "ANTIPRIGARNOE_POKRYTIE",
			"63" => "GRUZOPODEMNOST",
			"64" => "VYSOTA_RULYA",
			"65" => "NAGRUZKA",
			"66" => "TIP_KOLES",
			"67" => "KOLICHESTVO_KOLES",
			"68" => "DIAMETR_KOLES",
			"69" => "TORMOZ",
			"70" => "DLINA_DEKI",
			"71" => "DLYA_KURYASHCHIKH",
			"72" => "SALFETKI",
			"73" => "GARANTIYNYY_SROK",
			"74" => "ANKER_BOLT",
			"75" => "SHVABRY_S_OTZHIMOM",
			"76" => "SHVABRY_NASADKI",
			"77" => "OKNOMOYKI",
			"78" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"79" => "FENY_PROMYSHLENNYE",
			"80" => "VOZDUKHODUVKI",
			"81" => "ZHESTKOST",
			"82" => "ODNORAZOVYY",
			"83" => "SAYTBEZSKIDKI",
			...
			"85" => "ADMITAD_TARIFF",
			"86" => "OTPRAVLENO",
			"87" => "TOLKO_V_INTERNET_MAGAZINE",
			"88" => "NE_PRODAVAT_V_MINUS",
			"89" => "SOGLASOVANO",
			"90" => "OTPRAVLENY_ORIGINALY",
			"91" => "VOZVRAT_DOKUMENTOV",
