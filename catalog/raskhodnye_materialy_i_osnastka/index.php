...
$APPLICATION->SetTitle("Расходные материалы и оснастка");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/raskhodnye_materialy_i_osnastka/",
		"IBLOCK_ID" => "503",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"49" => "NAIMENOVANIE",
			"50" => "OBORUDOVANIE",
			"51" => "NE_VYGRUZHAT_NA_SAYT",
			"52" => "NAIMENOVANIE_DLYA_SAYTA",
			"53" => "FORMA",
			"54" => "TSVET",
			"55" => "NABOR",
			"56" => "DLYA_DETEY",
			...
			"81" => "VYSOTA_RULYA",
			"82" => "TIP_KOLES",
			"83" => "KOLICHESTVO_KOLES",
			"84" => "DIAMETR_KOLES",
			"85" => "TORMOZ",
			"86" => "DLINA_DEKI",
			"87" => "DLYA_KURYASHCHIKH",
			"88" => "ANKER_BOLT",
			"89" => "TIP",
			...
			"97" => "ADMITAD_TARIFF",
			"98" => "OTPRAVLENO",
			"99" => "TOLKO_V_INTERNET_MAGAZINE",
			"100" => "NE_PRODAVAT_V_MINUS",
