...
$APPLICATION->SetTitle("Посуда и кухонный инвентарь");
?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"mht", 
	array(
		"SEF_FOLDER" => "/catalog/posuda_i_kukhonnyy_inventar/",
		"IBLOCK_ID" => "550",
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			"19" => "DLYA_DETEY",
			"20" => "POKRYTIE",
			"21" => "ANTIPRIGARNOE_POKRYTIE",
			"22" => "KRYSHKA_V_KOMPLEKTE",
			"23" => "SEMNYE_RUCHKI",
			"24" => "POL",
			"25" => "KOLICHESTVO",
			"26" => "SOSTAV",
			...
			"66" => "ANKER_BOLT",
			"67" => "NAZNACHENIE_1",
			"68" => "SHVABRY_S_OTZHIMOM",
			"69" => "SHVABRY_NASADKI",
			"70" => "OKNOMOYKI",
			"71" => "TIP_1",
			"72" => "MATERIAL_1",
			"73" => "PISTOLETY_GORYACHEGO_VOZDUKHA",
			"74" => "FENY_PROMYSHLENNYE",
			"75" => "VOZDUKHODUVKI",
			"76" => "ADMITAD_TARIFF",
			"77" => "posudomoechnaya",
			"78" => "OTPRAVLENO",
			"79" => "NE_VYGRUZHAT_NA_SAYT",
			"80" => "TOLKO_V_INTERNET_MAGAZINE",
			"81" => "NE_PRODAVAT_V_MINUS",
			"82" => "SOGLASOVANO",
			"83" => "OTPRAVLENY_ORIGINALY",
			"84" => "VOZVRAT_DOKUMENTOV",
