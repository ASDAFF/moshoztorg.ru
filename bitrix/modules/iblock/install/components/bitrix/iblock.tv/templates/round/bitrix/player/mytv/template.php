...
<div id="myIDflv_<?=intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>" style="display:none; height: <?=$arResult['HEIGHT']+intval($arParams['ADDITIONAL_PARAMS']['HEIGHT_CORRECT']['FLV']);?>px">
	<object
		id="obj_FLVplayer_<?=intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>"
		name="obj_FLVplayer_<?=intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>"
		...
		<param name="wmode" value="<?=$arParams['WMODE']?>" />
		<param name="FlashVars" value="<?=$arResult['FLASH_VARS'].'&id=obj_FLVplayer_'.intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>" />
		<param name="allowScriptAccess" value="always" />
		<param name="allowfullscreen" value="true" />
		<embed
			id="FLVplayer_<?=intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>"
			...
			flashvars="<?=$arResult['FLASH_VARS'].'&id=FLVplayer_'.intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>"
		/>
	</object>
</div>
...
<div id="myIDflv_<?=intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>" style="display:none; height: <?=$arResult['HEIGHT']+intval($arParams['ADDITIONAL_PARAMS']['HEIGHT_CORRECT']['FLV'] - $arParams['ADDITIONAL_PARAMS']['HEIGHT_CORRECT']['WMV']);?>px">
	<object
		...
		<param name="movie" value="/bitrix/components/bitrix/player/mediaplayer/player.swf" />
		<param name="wmode" value="<?=$arParams['WMODE']?>" />
		<param name="FlashVars" value="logo=<?=$arParams['ADDITIONAL_PARAMS']['LOGO']?>&skin=<?=$arParams["SKIN_PATH"]?>/bitrix.swf&fullscreen=true&<?=$arResult['FLASH_VARS'].'&id=obj_FLVplayer_'.intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>" />
		<param name="allowScriptAccess" value="always" />
		<param name="allowfullscreen" value="true" />
		<embed
			id="FLVplayer_<?=intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>"
			...
			menu="<?=$arResult['MENU']?>"
			wmode="<?=$arResult['WMODE']?>"
			flashvars="logo=<?=$arParams['ADDITIONAL_PARAMS']['LOGO']?>&skin=<?=$arParams["SKIN_PATH"]?>/bitrix.swf&fullscreen=true&<?=$arResult['FLASH_VARS'].'&id=FLVplayer_'.intval($arParams['ADDITIONAL_PARAMS']['NUM'])?>"
		/>
	</object>
</div>
