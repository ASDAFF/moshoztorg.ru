...
/*ZDUyZmZZTg2NzY1NzU2MGI1YWI5MjljZGRjNGRkNTFlNDAzMDA=*/$GLOBALS['____1639044337']= array(base64_decode('ZGVmaW5l'));if(!function_exists(__NAMESPACE__.'\\___1343566561')){function ___1343566561($_763965290){static $_1019556597= false; if($_1019556597 == false) $_1019556597=array('R'.'U'.'5D'.'T0RF','WQ'.'='.'=');return base64_decode($_1019556597[$_763965290]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1221335912){ return true;} public static function IsFeatureEditable($_1221335912){ return true;} public static function SetFeatureEnabled($_1221335912, $_490054440= true){} public static function SaveFeaturesSettings($_182630028, $_664007634){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_502447285){} public static function ModifyFeaturesSettings($_502447285, $_1450105913){} public static function IsFeatureInstalled($_1221335912){ return true;}} $GLOBALS['____1639044337'][0](___1343566561(0), ___1343566561(1));/**/			//Do not remove this
