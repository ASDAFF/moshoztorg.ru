	...
	BX.Scale.Server.prototype.getHeaderObj = function()
	{
		...
		if(this.bxEnvVer)
		{
			if(this.bxEnvNeedUpdate)
				bxEnvVer = BX.message('SCALE_PANEL_JS_BX_ENV_VERSION')+' '+"<span style='color: red;' title='"+BX.message("SCALE_PANEL_JS_BX_ENV_NEED_UPDATE")+"'>"+this.bxEnvVer+"</span>";
			else
		...
		{
			bxEnvVer = BX.message('SCALE_PANEL_JS_BX_ENV_VERSION')+' '+"<span style='color: red;' title='"+BX.message("SCALE_PANEL_JS_BX_ENV_NOT_INSTALLED")+"'>0.0-0</span>";
		}
