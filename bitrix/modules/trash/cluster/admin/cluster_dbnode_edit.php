...
if($ID > 0)
{
	...
	$aMenu[] = array(
		"TEXT" => GetMessage("CLU_DBNODE_EDIT_MENU_ADD"),
		"TITLE" => GetMessage("CLU_DBNODE_EDIT_MENU_ADD_TITLE"),
		"LINK" => "cluster_dbnode_edit.php?lang=".LANGUAGE_ID.'&group_id='.$group_id,
		"ICON" => "btn_new",
	);
