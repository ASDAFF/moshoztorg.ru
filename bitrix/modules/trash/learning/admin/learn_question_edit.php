...
<?php $tabControl->BeginCustomField("NAME", GetMessage("LEARNING_NAME"), false);?>
	<tr class="adm-detail-required-field">
		<td><?echo $tabControl->GetCustomLabelHTML()?>:</td>
		<td valign="top">
			<textarea name="NAME" size="50" maxlength="255" style="width:440px"><?php echo htmlspecialcharsbx($str_NAME); ?></textarea>
		</td>
	</tr>
...
<?php $tabControl->BeginCustomField("COMMENT_TEXT", GetMessage("LEARNING_COMMENT"), false);?>
	<tr>
		<td><?echo $tabControl->GetCustomLabelHTML()?>:</td>
		<td valign="top">
			<textarea name="COMMENT_TEXT" size="50" style="width:440px"><?php echo htmlspecialcharsbx($str_COMMENT_TEXT); ?></textarea>
		</td>
	</tr>
			...
			<?php if ($str_QUESTION_TYPE != "T"):?>
				...
				if (is_array($ANSWER_HIDDEN_ID))
				{
					foreach($ANSWER_HIDDEN_ID as $id)
					{
						...
						{
							$arNewIDs[] = $id;
							$arNewIDsInt[] = intval(substr($id, 1));
						}
					}
				}
