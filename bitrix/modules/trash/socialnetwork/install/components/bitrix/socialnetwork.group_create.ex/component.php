...
$arResult["POST"]["USERS_FOR_JS"] = false;
$arResult["POST"]["USERS_FOR_JS_I"] = false;
$arResult["POST"]["USERS_FOR_JS_E"] = false;
	...
	if (StrLen($arResult["FatalError"]) <= 0)
	{
		...
		)
		{
			...
			else
			{
				...
				{
					$arResult["POST"]["USERS_FOR_JS"] = array();

					if ($arResult["bExtranetInstalled"])
					{
						$arResult["POST"]["USERS_FOR_JS_I"] = array();
						$arResult["POST"]["USERS_FOR_JS_E"] = array();
					}
