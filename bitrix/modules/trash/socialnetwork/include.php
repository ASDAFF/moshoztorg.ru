...
if (
	COption::GetOptionString("socialnetwork", "allow_forum_user", "Y") == "Y" 
	|| COption::GetOptionString("socialnetwork", "allow_forum_group", "Y") == "Y"
)
{
	$arFeatureTmp = array(
		"allowed" => array(),
...
if (
	COption::GetOptionString("socialnetwork", "allow_photo_user", "Y") == "Y" 
	|| COption::GetOptionString("socialnetwork", "allow_photo_group", "Y") == "Y"
)
{
	$arFeatureTmp = array(
		"allowed" => array(),
...
if (
	$bCalendar
	&& (
		COption::GetOptionString("socialnetwork", "allow_calendar_user", "Y") == "Y" 
		|| COption::GetOptionString("socialnetwork", "allow_calendar_group", "Y") == "Y"
	)
)
{
	$arFeatureTmp = array(
...
if (
	$bIntranet
	&& (
		COption::GetOptionString("socialnetwork", "allow_tasks_user", "Y") == "Y" 
		|| COption::GetOptionString("socialnetwork", "allow_tasks_group", "Y") == "Y"
	)
)
{
	$arFeatureTmp = array(
